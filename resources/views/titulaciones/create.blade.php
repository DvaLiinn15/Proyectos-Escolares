                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('opcion_titulacion_letra') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('estatus_titulacion') is-invalid @enderror" 
                                        ...
                                        <option value="Completado" {{ old('estatus_titulacion') == 'Completado' ? 'selected' : '' }}>Completado</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('fecha_expedicion_titulo') }}"
                                        required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('fecha_recepcion_dgest') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('periodo_ingreso_prepa') }}"
                                        placeholder="Ej: Enero 2018">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('periodo_egresa_prepa') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea 
                                        ...
                                        name="antecedentes" 
                                        rows="4"
                                        placeholder="Ej: Calificaciones altas">{{ old('antecedentes') }}</textarea>
                                    @error('antecedentes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea 
                                        ...
                                        name="tema" 
                                        rows="3"
                                        placeholder="Ej: Servidores web usando ubuntu"
                                        required>{{ old('tema') }}</textarea>
                                    @error('tema')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
